...
///
/// This page is intentionally interactive (not just a styling demo):
...
final class ApiBrowserIsolatedChannelsDemoPage extends StatefulWidget {
  const ApiBrowserIsolatedChannelsDemoPage({super.key});

  @override
  State<ApiBrowserIsolatedChannelsDemoPage> createState() => _ApiBrowserIsolatedChannelsDemoPageState();
}

final class _ApiBrowserIsolatedChannelsDemoPageState extends State<ApiBrowserIsolatedChannelsDemoPage> {
  final List<String> _log = <String>[];
  final TextEditingController _messageController = TextEditingController(text: 'Hello from API Browser');
  final TextEditingController _confirmTitleController = TextEditingController(text: 'Allow action?');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Isolated Channels Demo')),
      body: Padding(
